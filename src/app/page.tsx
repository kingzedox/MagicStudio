...
import { Zap, MousePointer2, Sparkles, Wand2 } from "lucide-react";
...
export default function HomePage() {
  ...
  // Removed unused useWallet
  const isDark = true; // Keeping the dark aesthetic
      ...
      <section className="mt-[15px] relative pt-[110px] pb-[130px] px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className={`relative inline-block border-[1.5px] p-6 sm:p-10 mb-[15px] ${isDark ? 'border-neutral-700' : 'border-black'}`}>
          ...
          <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight max-w-5xl leading-[1.3] sm:leading-[1.4] ${
            ...
            Design with AI. <span className="inline-block px-4 py-0 sm:py-1 bg-[#FF4564] text-white rounded-2xl mx-1 align-middle -translate-y-1 shadow-sm">Mint</span> on Solana. <br className="hidden md:block" />
            <span className="inline-block px-4 py-0 sm:py-1 bg-[#d6ff50] text-[#3b4712] rounded-2xl mx-1 align-middle -translate-y-1 shadow-sm mt-3 sm:mt-0">Zero Code.</span>
          </h1>
        </div>
        ...
        <p className={`text-base sm:text-xl max-w-2xl leading-relaxed mb-[44px] ${
          ...
          The all-in-one NFT creation studio for artists. Draw, generate AI art, and mint directly to Solana via Metaplex Core.
        </p>
        ...
        <div className="w-full max-w-6xl mx-auto mt-12">
          ...
          <div className="flex flex-row items-start justify-between gap-2 sm:gap-4 overflow-x-auto no-scrollbar pb-2">
            <div className="flex flex-col items-center justify-center flex-1 min-w-[140px]">
              ...
              <div className={`text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-1 ${isDark ? 'text-neutral-300' : 'text-neutral-500'}`}>AI Generation</div>
            ...
            <div className="flex flex-col items-center justify-center flex-1 min-w-[140px]">
              ...
              <div className={`text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-1 ${isDark ? 'text-neutral-300' : 'text-neutral-500'}`}>Mint Cost</div>
              <div className={`text-[8px] sm:text-[10px] leading-tight px-2 ${isDark ? 'text-neutral-500' : 'text-neutral-400'}`}>
            ...
            <div className="flex flex-col items-center justify-center flex-1 min-w-[140px]">
              ...
              <div className={`text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-1 ${isDark ? 'text-neutral-300' : 'text-neutral-500'}`}>Metadata</div>
              <div className={`text-[8px] sm:text-[10px] leading-tight px-2 ${isDark ? 'text-neutral-500' : 'text-neutral-400'}`}>
            ...
            <div className="flex flex-col items-center justify-center flex-1 min-w-[140px]">
              ...
              <div className={`text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-1 ${isDark ? 'text-neutral-300' : 'text-neutral-500'}`}>Decentralized</div>
              <div className={`text-[8px] sm:text-[10px] leading-tight px-2 ${isDark ? 'text-neutral-500' : 'text-neutral-400'}`}>
                Pinata IPFS Storage
              </div>
            </div>
            ...
            {[
              {
                ...
                tags: 'Konva Canvas, Pen Tool, Vector Shapes',
                description: 'Full creative freedom. Draw with a pen, add shapes, text, and structure your layout with a highly optimized vector engine directly in the browser.'
              },
              {
                id: '02',
                title: 'Generative AI',
                tags: 'Hugging Face, GROQ Metadata',
                description: 'Prompt AI to generate art directly onto your canvas, and use our GROQ integration to automatically write compliant Metaplex metadata based on your layers.'
              },
              {
                id: '03',
                title: 'Metaplex Core',
                tags: 'One-Click Mint, Pinata IPFS, Solana',
                description: 'Upload your finalized art to IPFS via Pinata and mint it as a next-generation Metaplex Core NFT for only fractions of a cent on Solana.'
              }
            ].map((feature, i) => (
              <div 
                key={i}
              ...
              {[
                {
                  step: "Step 1",
                  title: "Create Room",
                  description: "Initialize a new session and invite your collaborators to design alongside you.",
                  visual: (
                ...
                },
                {
                  step: "Step 2",
                  title: "Design",
                  description: "Use the freehand pen, shapes, and tools to construct your masterpiece directly in your browser.",
                  visual: (
                ...
                },
                {
                  step: "Step 3",
                  title: "AI Generation",
                  description: "Describe what you want, and let AI generate assets or completely autofill your NFT metadata.",
                  visual: (
                    <div className="relative w-full h-full flex items-center justify-center">
                      <div className="flex items-center gap-2 relative">
                        <div className="w-14 h-14 rounded-2xl bg-[#FF4564]/10 border border-[#FF4564]/30 flex items-center justify-center z-10 relative overflow-hidden">
                          ...
                          <Wand2 className="w-6 h-6 text-[#FF4564] relative z-10" />
                        </div>
                      </div>
                    </div>
                  )
                },
                {
                  step: "Step 4",
                  title: "Mint",
                  description: "We upload the artwork and metadata to Pinata IPFS and trigger a Metaplex Core mint transaction to your wallet.",
                  visual: (
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-8 mb-16 px-4 md:px-0 text-center md:text-left w-full">
             <div className="max-w-sm flex flex-col items-center md:items-start w-full">
                <p className="text-[#a0a0a0] text-sm leading-relaxed mb-6">
                  Create AI-Powered NFTs effortlessly on Solana.
                </p>
                <div className="flex items-center justify-center md:justify-start flex-wrap gap-4 w-full md:w-auto">
                  <a href="https://x.com/kingzedox0" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center hover:bg-neutral-800 transition-colors">
                  ...
                  <a href="https://github.com/kingzedox/MagicStudio" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center hover:bg-neutral-800 transition-colors">
